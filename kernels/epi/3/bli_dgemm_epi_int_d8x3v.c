...
void bli_dgemm_epi_scalar_8x3v
     (
       dim_t               m,
       dim_t               n,
       dim_t               k,
     ...
     )
{
	...
	for ( i = 0; i < k_iter; ++i )
	{
		// Begin iteration 0
 		...
 		bv01 = __builtin_epi_vload_1xf64( b+1*vlen, gvl );
 		bv02 = __builtin_epi_vload_1xf64( b+2*vlen, gvl );
	...
	if ( *beta != 0.0 ) {
		...
		//printf("bnzero cs_c == 1; rs_c == %d\n", rs_c);
 		cv0 = __builtin_epi_vload_1xf64( c + 0*rs_c + 0*cs_c + 0*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv00, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 0*rs_c + 0*cs_c+0*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 1*rs_c + 0*cs_c + 0*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv10, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 1*rs_c + 0*cs_c+0*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 2*rs_c + 0*cs_c + 0*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv20, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 2*rs_c + 0*cs_c+0*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 3*rs_c + 0*cs_c + 0*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv30, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 3*rs_c + 0*cs_c+0*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 4*rs_c + 0*cs_c + 0*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv40, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 4*rs_c + 0*cs_c+0*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 5*rs_c + 0*cs_c + 0*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv50, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 5*rs_c + 0*cs_c+0*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 6*rs_c + 0*cs_c + 0*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv60, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 6*rs_c + 0*cs_c+0*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 7*rs_c + 0*cs_c + 0*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv70, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 7*rs_c + 0*cs_c+0*vlen*cs_c,    cv0, gvl );

		// ==== 
 		cv0 = __builtin_epi_vload_1xf64( c + 0*rs_c + 0*cs_c + 1*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv01, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 0*rs_c + 0*cs_c+1*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 1*rs_c + 0*cs_c + 1*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv11, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 1*rs_c + 0*cs_c+1*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 2*rs_c + 0*cs_c + 1*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv21, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 2*rs_c + 0*cs_c+1*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 3*rs_c + 0*cs_c + 1*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv31, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 3*rs_c + 0*cs_c+1*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 4*rs_c + 0*cs_c + 1*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv41, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 4*rs_c + 0*cs_c+1*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 5*rs_c + 0*cs_c + 1*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv51, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 5*rs_c + 0*cs_c+1*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 6*rs_c + 0*cs_c + 1*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv61, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 6*rs_c + 0*cs_c+1*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 7*rs_c + 0*cs_c + 1*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv71, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 7*rs_c + 0*cs_c+1*vlen*cs_c,    cv0, gvl );

		// ==
 		cv0 = __builtin_epi_vload_1xf64( c + 0*rs_c + 0*cs_c + 2*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv02, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 0*rs_c + 0*cs_c+2*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 1*rs_c + 0*cs_c + 2*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv12, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 1*rs_c + 0*cs_c+2*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 2*rs_c + 0*cs_c + 2*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv22, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 2*rs_c + 0*cs_c+2*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 3*rs_c + 0*cs_c + 2*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv32, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 3*rs_c + 0*cs_c+2*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 4*rs_c + 0*cs_c + 2*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv42, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 4*rs_c + 0*cs_c+2*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 5*rs_c + 0*cs_c + 2*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv52, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 5*rs_c + 0*cs_c+2*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 6*rs_c + 0*cs_c + 2*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv62, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 6*rs_c + 0*cs_c+2*vlen*cs_c,    cv0, gvl );

 		cv0 = __builtin_epi_vload_1xf64( c + 7*rs_c + 0*cs_c + 2*vlen*cs_c, gvl );
	        cv0 = __builtin_epi_vfmacc_1xf64( abv72, cv0, betav, gvl );
		__builtin_epi_vstore_1xf64( c + 7*rs_c + 0*cs_c+2*vlen*cs_c,    cv0, gvl );
