     ...
     )
{
	...
	long gvl = __builtin_epi_vsetvl( 4, __epi_e32, __epi_m1 );
	//float32x4_t alphav;
	__epi_2xf32 alphav;
	...
	if( rs_c == 1 )
	{
		// Load column 0
 		...
 		cv0 = __builtin_epi_vload_2xf32( c + 0*rs_c + 0*cs_c, gvl ); 
	
		// Load column 1
 		//cv1 = vld1q_f32( c + 0*rs_c + 1*cs_c ); 
 		cv1 = __builtin_epi_vload_2xf32( c + 0*rs_c + 1*cs_c, gvl ); 
	
		// Load column 2
 		//cv2 = vld1q_f32( c + 0*rs_c + 2*cs_c ); 
 		cv2 = __builtin_epi_vload_2xf32( c + 0*rs_c + 2*cs_c, gvl ); 
	
		// Load column 3
 		//cv3 = vld1q_f32( c + 0*rs_c + 3*cs_c ); 
 		cv3 = __builtin_epi_vload_2xf32( c + 0*rs_c + 3*cs_c, gvl ); 
	}	
	...
	abv0 = __builtin_epi_vfmv_v_f_2xf32( 0.0, gvl );
	...
	abv1 = __builtin_epi_vfmv_v_f_2xf32( 0.0, gvl );
	...
	abv2 = __builtin_epi_vfmv_v_f_2xf32( 0.0, gvl );
	...
	abv3 = __builtin_epi_vfmv_v_f_2xf32( 0.0, gvl );
	...
	{ 
		// Begin iter 0
 		//av1 = vld1q_f32( a ); 
 		av1 = __builtin_epi_vload_2xf32( a, gvl ); 

 		//bv1 = vld1q_f32( b ); 
 		bv1 = __builtin_epi_vload_2xf32( b, gvl ); 

		//abv0 = vmlaq_lane_f32( abv0, av1, vget_low_f32(bv1), 0 );
		tmpv = __builtin_epi_vsplat_2xf32( bv1, 0, gvl );
		abv0 = __builtin_epi_vfmacc_2xf32( abv0, av1, tmpv, gvl );
		//abv1 = vmlaq_lane_f32( abv1, av1, vget_low_f32(bv1), 1 );
		tmpv = __builtin_epi_vsplat_2xf32( bv1, 1, gvl );
		abv1 = __builtin_epi_vfmacc_2xf32( abv1, av1, tmpv, gvl );
		//abv2 = vmlaq_lane_f32( abv2, av1, vget_high_f32(bv1), 0 );
		tmpv = __builtin_epi_vsplat_2xf32( bv1, 2, gvl );
		abv2 = __builtin_epi_vfmacc_2xf32( abv2, av1, tmpv, gvl );
		//abv3 = vmlaq_lane_f32( abv3, av1, vget_high_f32(bv1), 1 );
		tmpv = __builtin_epi_vsplat_2xf32( bv1, 3, gvl );
		abv3 = __builtin_epi_vfmacc_2xf32( abv3, av1, tmpv, gvl );

		//av2 = vld1q_f32( a+4 ); 
 		av2 = __builtin_epi_vload_2xf32( a+4, gvl ); 

 		//bv2 = vld1q_f32( b+4 ); 
 		bv2 = __builtin_epi_vload_2xf32( b+4, gvl ); 

		//abv0 = vmlaq_lane_f32( abv0, av2, vget_low_f32(bv2), 0 );
		tmpv = __builtin_epi_vsplat_2xf32( bv2, 0, gvl );
		abv0 = __builtin_epi_vfmacc_2xf32( abv0, av2, tmpv, gvl );
		//abv1 = vmlaq_lane_f32( abv1, av2, vget_low_f32(bv2), 1 );
		tmpv = __builtin_epi_vsplat_2xf32( bv2, 1, gvl );
		abv1 = __builtin_epi_vfmacc_2xf32( abv1, av2, tmpv, gvl );
		//abv2 = vmlaq_lane_f32( abv2, av2, vget_high_f32(bv2), 0 );
		tmpv = __builtin_epi_vsplat_2xf32( bv2, 2, gvl );
		abv2 = __builtin_epi_vfmacc_2xf32( abv2, av2, tmpv, gvl );
		//abv3 = vmlaq_lane_f32( abv3, av2, vget_high_f32(bv2), 1 );
		tmpv = __builtin_epi_vsplat_2xf32( bv2, 3, gvl );
		abv3 = __builtin_epi_vfmacc_2xf32( abv3, av2, tmpv, gvl );

		//av3 = vld1q_f32( a+8 ); 
 		av3 = __builtin_epi_vload_2xf32( a+8, gvl ); 

 		//bv3 = vld1q_f32( b+8 ); 
 		bv3 = __builtin_epi_vload_2xf32( b+8, gvl ); 

		//abv0 = vmlaq_lane_f32( abv0, av3, vget_low_f32(bv3), 0 );
		tmpv = __builtin_epi_vsplat_2xf32( bv3, 0, gvl );
		abv0 = __builtin_epi_vfmacc_2xf32( abv0, av3, tmpv, gvl );
		//abv1 = vmlaq_lane_f32( abv1, av3, vget_low_f32(bv3), 1 );
		tmpv = __builtin_epi_vsplat_2xf32( bv3, 1, gvl );
		abv1 = __builtin_epi_vfmacc_2xf32( abv1, av3, tmpv, gvl );
		//abv2 = vmlaq_lane_f32( abv2, av3, vget_high_f32(bv3), 0 );
		tmpv = __builtin_epi_vsplat_2xf32( bv3, 2, gvl );
		abv2 = __builtin_epi_vfmacc_2xf32( abv2, av3, tmpv, gvl );
		//abv3 = vmlaq_lane_f32( abv3, av3, vget_high_f32(bv3), 1 );
		tmpv = __builtin_epi_vsplat_2xf32( bv3, 3, gvl );
		abv3 = __builtin_epi_vfmacc_2xf32( abv3, av3, tmpv, gvl );

		//av4 = vld1q_f32( a+12); 
 		av4 = __builtin_epi_vload_2xf32( a+12, gvl ); 

 		//bv4 = vld1q_f32( b+12); 
 		bv4 = __builtin_epi_vload_2xf32( b+12, gvl ); 

		//abv0 = vmlaq_lane_f32( abv0, av4, vget_low_f32(bv4), 0 );
		tmpv = __builtin_epi_vsplat_2xf32( bv4, 0, gvl );
		abv0 = __builtin_epi_vfmacc_2xf32( abv0, av4, tmpv, gvl );
		//abv1 = vmlaq_lane_f32( abv1, av4, vget_low_f32(bv4), 1 );
		tmpv = __builtin_epi_vsplat_2xf32( bv4, 1, gvl );
		abv1 = __builtin_epi_vfmacc_2xf32( abv1, av4, tmpv, gvl );
		//abv2 = vmlaq_lane_f32( abv2, av4, vget_high_f32(bv4), 0 );
		tmpv = __builtin_epi_vsplat_2xf32( bv4, 2, gvl );
		abv2 = __builtin_epi_vfmacc_2xf32( abv2, av4, tmpv, gvl );
		//abv3 = vmlaq_lane_f32( abv3, av4, vget_high_f32(bv4), 1 );
		tmpv = __builtin_epi_vsplat_2xf32( bv4, 3, gvl );
		abv3 = __builtin_epi_vfmacc_2xf32( abv3, av4, tmpv, gvl );
	...
	cv3 = __builtin_epi_vfmul_2xf32( cv3, betav, gvl );

	//cv0 = vmlaq_f32( cv0, abv0, alphav );
	//This segfaults if cv0 = .... ( cv0, ...
	cv0 = __builtin_epi_vfmacc_2xf32( cv0, alphav, abv0, gvl );
	//cv1 = vmlaq_f32( cv1, abv1, alphav );
	cv1 = __builtin_epi_vfmacc_2xf32( cv1, alphav, abv1, gvl );
	//cv2 = vmlaq_f32( cv2, abv2, alphav );
	cv2 = __builtin_epi_vfmacc_2xf32( cv2, alphav, abv2, gvl );
	//cv3 = vmlaq_f32( cv3, abv3, alphav );
	cv3 = __builtin_epi_vfmacc_2xf32( cv3, alphav, abv3, gvl );

	if( rs_c == 1 )
	{
		// Store column 0
  		//vst1q_f32( c + 0*rs_c + 0*cs_c, cv0 ); 
		__builtin_epi_vstore_2xf32( c + 0*rs_c + 0*cs_c, cv0, gvl );
		// Store column 1
  		//vst1q_f32( c + 0*rs_c + 1*cs_c, cv1 ); 
		__builtin_epi_vstore_2xf32( c + 0*rs_c + 1*cs_c, cv1, gvl );
		// Store column 2
  		//vst1q_f32( c + 0*rs_c + 2*cs_c, cv2 ); 
		__builtin_epi_vstore_2xf32( c + 0*rs_c + 2*cs_c, cv2, gvl );
		// Store column 3
  		//vst1q_f32( c + 0*rs_c + 3*cs_c, cv3 ); 
		__builtin_epi_vstore_2xf32( c + 0*rs_c + 3*cs_c, cv3, gvl );
	}
